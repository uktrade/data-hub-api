...
with DisableSignals():
    ...
    # Specify quantities
    NUMBER_OF_ADVISERS = 10
    NUMBER_OF_COMPANIES = 10
    NUMBER_OF_CONTACTS = 10
    NUMBER_OF_EVENTS = 10
    NUMBER_OF_INTERACTIONS = 10
    NUMBER_OF_INVESTMENT_PROJECTS = 10000
    NUMBER_OF_ORDERS = 10

    # Generate Investment Projects
    print('\nGenerating investment projects...')  # noqa
    generate_investment_projects(NUMBER_OF_INVESTMENT_PROJECTS)
    print(f'\Generated {NUMBER_OF_INVESTMENT_PROJECTS} investment projects...')  # noqa
