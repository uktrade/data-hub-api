...
ENABLE_NEW_EXPORT_INTERACTION_REMINDERS = env.bool('ENABLE_NEW_EXPORT_INTERACTION_REMINDERS', False)
ENABLE_NEW_EXPORT_INTERACTION_REMINDERS_EMAIL_DELIVERY_STATUS = env.bool('ENABLE_NEW_EXPORT_INTERACTION_REMINDERS_EMAIL_DELIVERY_STATUS', False)
