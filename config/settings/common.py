...
# Activity Stream
ACTIVITY_STREAM_INCOMING_IP_WHITELIST = env('ACTIVITY_STREAM_INCOMING_IP_WHITELIST', default='')
# Defaults are not used so we don't accidentally expose the endpoint
# with default credentials
ACTIVITY_STREAM_INCOMING_ACCESS_KEY_ID = env('ACTIVITY_STREAM_INCOMING_ACCESS_KEY_ID')
ACTIVITY_STREAM_INCOMING_SECRET_ACCESS_KEY = env('ACTIVITY_STREAM_INCOMING_SECRET_ACCESS_KEY')
ACTIVITY_STREAM_INCOMING_NONCE_EXPIRY_SECONDS = 60

ACTIVITY_STREAM_OUTGOING_URL = env('ACTIVITY_STREAM_OUTGOING_URL')
ACTIVITY_STREAM_OUTGOING_ACCESS_KEY_ID = env('ACTIVITY_STREAM_OUTGOING_ACCESS_KEY_ID')
ACTIVITY_STREAM_OUTGOING_SECRET_ACCESS_KEY = env('ACTIVITY_STREAM_OUTGOING_SECRET_ACCESS_KEY')
