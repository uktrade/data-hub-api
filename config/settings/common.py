...
# EXPORT WINS
EXPORT_WINS_NOTIFICATION_API_KEY = env(
    'EXPORT_WINS_NOTIFICATION_API_KEY',
    default='',
)
EXPORT_WINS_CLIENT_RECEIPT_TEMPLATE_ID = env(
    'EXPORT_WINS_CLIENT_RECEIPT_TEMPLATE_ID',
    default='',
)
EXPORT_WINS_LEAD_OFFICER_APPROVED_TEMPLATE_ID = env(
    'EXPORT_WINS_LEAD_OFFICER_APPROVED_TEMPLATE_ID',
    default='',
)
EXPORT_WINS_LEAD_OFFICER_REJECTED_TEMPLATE_ID = env(
    'EXPORT_WINS_LEAD_OFFICER_REJECTED_TEMPLATE_ID',
    default='',
)
