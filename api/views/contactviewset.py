...
from api.serializers.contactserializer import ContactSerializer, ContactSaveSerializer
...
class ContactViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, **kwargs):
        ...
        serializer = ContactSaveSerializer(data=request.data)
        ...
        response_serializer = ContactSaveSerializer(new_contact)
    ...
    def update(self, request, *args, **kwargs):
        ...
        serializer = ContactSaveSerializer(instance, data=request.data, partial=partial)
        serializer.is_valid(raise_exception=True)
