...
def dnb_company_search_datahub_companies():
    ...
    company = CompanyFactory(
        duns_number="7654321", id="6083b732-b07a-42d6-ada4-c99999999999"
    )

    interaction_date = datetime.datetime(
        year=2019, month=8, day=1, hour=16, minute=0, tzinfo=utc
    )
...
@pytest.fixture
def dnb_hierarchy_response():
    """
    Fixture for a hierarchy record as returned by the dnb-service.
    """
    return {
        "global_ultimate_duns": "111111111",
        "global_ultimate_family_tree_members_count": 3,
        "branches_excluded_members_count": 3,
        "family_tree_members": [
            {
                "duns": "111111111",
                "primaryName": "Top Level LIMITED",
                "corporateLinkage": {
                    "hierarchyLevel": 1,
                },
            },
            {
                ...
                "corporateLinkage": {
                    "hierarchyLevel": 2,
                    "parent": {"duns": "111111111"},
                },
            },
            {
                "duns": "333333333",
                "primaryName": "Third LIMITED",
                "corporateLinkage": {
                    "hierarchyLevel": 2,
                    "parent": {"duns": "111111111"},
                },
