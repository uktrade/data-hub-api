...
def search_dnb(query_params, request=None):
    """Queries the dnb-service with the given query_params.
...
def append_datahub_details(family_tree_members: list):
    ...
    for family_member in family_tree_members:
        ...
        trading_names = family_member.get('tradeStyleNames', [])
        family_member['tradeStyleNames'] = [item['name'] for item in trading_names]
