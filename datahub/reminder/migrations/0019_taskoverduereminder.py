...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('reminder', '0018_merge_20231110_1056'),
    ]

    operations = [
        migrations.CreateModel(
            name='TaskOverdueReminder',
            fields=[
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task_overdue_reminder', to='task.task')),
            ],
            options={
                'abstract': False,
            },
