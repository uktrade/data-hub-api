...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            '\n'.join([
                'mx.google.com;',
                'dkim=pass header.i=@trade.gov.uk header.s=selector1 header.b=foobar;',
                'spf=pass (google.com: domain of bill.adama@trade.gov.uk designates '
                'XX.XXX.XX.XX as permitted sender) smtp.mailfrom=bill.adama@trade.gov.uk;',
                'dmarc=pass (p=QUARANTINE sp=QUARANTINE dis=NONE) header.from=trade.gov.uk',
            ]),
            True,
        ),
        ...
        (
            ...
            '\n'.join([
                'mx.google.com;',
                'dkim=fail header.i=@trade.gov.uk header.s=selector1 header.b=foobar;',
                'spf=pass (google.com: domain of bill.adama@trade.gov.uk designates '
                'XX.XXX.XX.XX as permitted sender) smtp.mailfrom=bill.adama@trade.gov.uk;',
                'dmarc=pass (p=QUARANTINE sp=QUARANTINE dis=NONE) header.from=trade.gov.uk',
            ]),
        ...
        (
            ...
            '\n'.join([
                'mx.google.com;',
                'dkim=pass header.i=@trade.gov.uk header.s=selector1 header.b=foobar;',
                'spf=fail (google.com: domain of bill.adama@trade.gov.uk designates '
                'XX.XXX.XX.XX as permitted sender) smtp.mailfrom=bill.adama@trade.gov.uk;',
                'dmarc=pass (p=QUARANTINE sp=QUARANTINE dis=NONE) header.from=trade.gov.uk',
            ]),
            False,
        ...
        (
            ...
            '\n'.join([
                ...
                'spf=pass (google.com: domain of bill.adama@trade.gov.uk designates ',
                'XX.XXX.XX.XX as permitted sender) smtp.mailfrom=bill.adama@trade.gov.uk;',
                'dmarc=fail (p=QUARANTINE sp=QUARANTINE dis=NONE) header.from=trade.gov.uk',
            ]),
            False,
        ),
        ...
        (
            ...
            '\n'.join([
                ...
                'dkim=pass header.i=@trade.gov.uk header.s=selector1 header.b=foobar;',
                'spf=pass (google.com: domain of bill.adama@trade.gov.uk designates ',
                'XX.XXX.XX.XX as permitted sender) smtp.mailfrom=foobar@trade.gov.uk;',
                'dmarc=pass (p=QUARANTINE sp=QUARANTINE dis=NONE) header.from=trade.gov.uk',
            ]),
            False,
        ),
