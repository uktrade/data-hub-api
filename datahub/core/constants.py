...
class BusinessType(Enum):
    ...
    government_dept = Constant('Government Dept',
    ...
    private_limited_company = Constant('Private limited company',
                                       '9ed14e94-5d95-e211-a939-e4115bead28a')
    public_limited_company = Constant('Public limited company',
                                      '9ed14e94-5d95-e211-a939-e4115bead28a')
...
class Country(Enum):
    ...
    afghanistan = Constant('Afghanistan',
                           '87756b9a-5d95-e211-a939-e4115bead28a')
    aland_islands = Constant('Aland Islands',
                             '88756b9a-5d95-e211-a939-e4115bead28a')
    ...
    american_samoa = Constant('American Samoa',
                              '965f66a0-5d95-e211-a939-e4115bead28a')
    ...
    antigua_and_barbuda = Constant('Antigua and Barbuda',
                                   '9b5f66a0-5d95-e211-a939-e4115bead28a')
    ...
    bosnia_and_herzegovina = Constant('Bosnia and Herzegovina',
                                      'ad5f66a0-5d95-e211-a939-e4115bead28a')
    botswana = Constant('Botswana', 'ae5f66a0-5d95-e211-a939-e4115bead28a')
    bouvet_island = Constant('Bouvet Island',
                             'af5f66a0-5d95-e211-a939-e4115bead28a')
    brazil = Constant('Brazil', 'b05f66a0-5d95-e211-a939-e4115bead28a')
    british_indian_ocean_territory = Constant(
        'British Indian Ocean Territory',
        'b15f66a0-5d95-e211-a939-e4115bead28a')
    british_virgin_islands = Constant('British Virgin Islands',
                                      'b25f66a0-5d95-e211-a939-e4115bead28a')
    ...
    cayman_islands = Constant('Cayman Islands',
                              '5faf72a6-5d95-e211-a939-e4115bead28a')
    central_african_republic = Constant('Central African Republic',
                                        '60af72a6-5d95-e211-a939-e4115bead28a')
    ...
    christmas_island = Constant('Christmas Island',
                                '64af72a6-5d95-e211-a939-e4115bead28a')
    cocos_keeling_islands = Constant('Cocos (Keeling) Islands',
                                     '65af72a6-5d95-e211-a939-e4115bead28a')
    ...
    czech_republic = Constant('Czech Republic',
                              '6faf72a6-5d95-e211-a939-e4115bead28a')
    ...
    dominican_republic = Constant('Dominican Republic',
                                  '73af72a6-5d95-e211-a939-e4115bead28a')
    ...
    el_salvador = Constant('El Salvador',
                           'd2f682ac-5d95-e211-a939-e4115bead28a')
    equatorial_guinea = Constant('Equatorial Guinea',
                                 'd3f682ac-5d95-e211-a939-e4115bead28a')
    ...
    falkland_islands = Constant('Falkland Islands',
                                'd7f682ac-5d95-e211-a939-e4115bead28a')
    faroe_islands = Constant('Faroe Islands',
                             'd8f682ac-5d95-e211-a939-e4115bead28a')
    ...
    french_guiana = Constant('French Guiana',
                             'dbf682ac-5d95-e211-a939-e4115bead28a')
    french_polynesia = Constant('French Polynesia',
                                'dcf682ac-5d95-e211-a939-e4115bead28a')
    ...
    gambia, _the = Constant('Gambia, The',
                            'dff682ac-5d95-e211-a939-e4115bead28a')
    ...
    isle_of_man = Constant('Isle of Man',
                           '79756b9a-5d95-e211-a939-e4115bead28a')
    israel = Constant('Israel', '746a9ab2-5d95-e211-a939-e4115bead28a')
    italy = Constant('Italy', '84756b9a-5d95-e211-a939-e4115bead28a')
    ivory_coast = Constant('Ivory Coast',
                           '756a9ab2-5d95-e211-a939-e4115bead28a')
    ...
    korea_north = Constant('Korea (North)',
                           '7b6a9ab2-5d95-e211-a939-e4115bead28a')
    korea_south = Constant('Korea (South)',
                           '7c6a9ab2-5d95-e211-a939-e4115bead28a')
    ...
    liechtenstein = Constant('Liechtenstein',
                             '856a9ab2-5d95-e211-a939-e4115bead28a')
    ...
    marshall_islands = Constant('Marshall Islands',
                                '0950bdb8-5d95-e211-a939-e4115bead28a')
    ...
    netherlands = Constant('Netherlands',
                           '1950bdb8-5d95-e211-a939-e4115bead28a')
    netherlands_antilles = Constant('Netherlands Antilles',
                                    '1a50bdb8-5d95-e211-a939-e4115bead28a')
    new_caledonia = Constant('New Caledonia',
                             '1b50bdb8-5d95-e211-a939-e4115bead28a')
    new_zealand = Constant('New Zealand',
                           '1c50bdb8-5d95-e211-a939-e4115bead28a')
    ...
    norfolk_island = Constant('Norfolk Island',
                              '4761b8be-5d95-e211-a939-e4115bead28a')
    northern_mariana_islands = Constant('Northern Mariana Islands',
                                        '4861b8be-5d95-e211-a939-e4115bead28a')
    norway = Constant('Norway', '4961b8be-5d95-e211-a939-e4115bead28a')
    occupied_palestinian_territories = Constant(
    ...
    papua_new_guinea = Constant('Papua New Guinea',
                                '4e61b8be-5d95-e211-a939-e4115bead28a')
    paraguay = Constant('Paraguay', '4f61b8be-5d95-e211-a939-e4115bead28a')
    peru = Constant('Peru', '5061b8be-5d95-e211-a939-e4115bead28a')
    philippines = Constant('Philippines',
                           '5161b8be-5d95-e211-a939-e4115bead28a')
    ...
    puerto_rico = Constant('Puerto Rico',
                           '5561b8be-5d95-e211-a939-e4115bead28a')
    ...
    sao_tome_and_principe = Constant('Sao Tome and Principe',
                                     '5d61b8be-5d95-e211-a939-e4115bead28a')
    saudi_arabia = Constant('Saudi Arabia',
    ...
    sierra_leone = Constant('Sierra Leone',
                            '1e0be5c4-5d95-e211-a939-e4115bead28a')
    ...
    solomon_islands = Constant('Solomon Islands',
                               '220be5c4-5d95-e211-a939-e4115bead28a')
    somalia = Constant('Somalia', '230be5c4-5d95-e211-a939-e4115bead28a')
    south_africa = Constant('South Africa',
                            '240be5c4-5d95-e211-a939-e4115bead28a')
    south_georgia_and_south_sandwich_islands = Constant(
    ...
    st_barthelemy = Constant('St Barthelemy',
                             '7b756b9a-5d95-e211-a939-e4115bead28a')
    st_helena = Constant('St Helena', '270be5c4-5d95-e211-a939-e4115bead28a')
    st_kitts_and_nevis = Constant('St Kitts and Nevis',
                                  '280be5c4-5d95-e211-a939-e4115bead28a')
    ...
    st_pierre_and_miquelon = Constant('St Pierre and Miquelon',
                                      '2a0be5c4-5d95-e211-a939-e4115bead28a')
    ...
    switzerland = Constant('Switzerland',
                           '310be5c4-5d95-e211-a939-e4115bead28a')
    ...
    trinidad_and_tobago = Constant('Trinidad and Tobago',
                                   'ac6ee1ca-5d95-e211-a939-e4115bead28a')
    tunisia = Constant('Tunisia', 'ad6ee1ca-5d95-e211-a939-e4115bead28a')
    turkey = Constant('Turkey', 'ae6ee1ca-5d95-e211-a939-e4115bead28a')
    turkmenistan = Constant('Turkmenistan',
                            'af6ee1ca-5d95-e211-a939-e4115bead28a')
    turks_and_caicos_islands = Constant('Turks and Caicos Islands',
                                        'b06ee1ca-5d95-e211-a939-e4115bead28a')
    ...
    united_arab_emirates = Constant('United Arab Emirates',
                                    'b46ee1ca-5d95-e211-a939-e4115bead28a')
    united_kingdom = Constant('United Kingdom',
                              '80756b9a-5d95-e211-a939-e4115bead28a')
    united_states = Constant('United States',
                             '81756b9a-5d95-e211-a939-e4115bead28a')
    united_states_minor_outlying_islands = Constant(
    ...
    vatican_city = Constant('Vatican City',
                            'eef682ac-5d95-e211-a939-e4115bead28a')
    ...
    virgin_islands = Constant('Virgin Islands (US)',
                              'bb6ee1ca-5d95-e211-a939-e4115bead28a')
    wallis_and_futuna = Constant('Wallis and Futuna',
                                 '34afd8d0-5d95-e211-a939-e4115bead28a')
    western_sahara = Constant('Western Sahara',
...
class InteractionType(Enum):
    ...
    business_card = Constant('Business Card',
                             'a6d71fdd-5d95-e211-a939-e4115bead28a')
    email_website = Constant('Email/Website',
                             '70c226d7-5d95-e211-a939-e4115bead28a')
    face_to_face = Constant('Face to Face',
                            'a5d71fdd-5d95-e211-a939-e4115bead28a')
    ...
    social_media = Constant('Social Media',
                            'a8d71fdd-5d95-e211-a939-e4115bead28a')
    ...
    ukti_website = Constant('UKTI Website',
                            '75c226d7-5d95-e211-a939-e4115bead28a')
    video_teleconf = Constant('Video/Teleconf.',
                              'a7d71fdd-5d95-e211-a939-e4115bead28a')
...
class Role(Enum):
    ...
    leftorganisation = Constant('LeftOrganisation',
                                '6c756b9a-5d95-e211-a939-e4115bead28a')
    managing_director = Constant('Managing Director',
                                 'dc02a687-5da3-e211-a646-e4115bead28a')
...
class Title(Enum):
    ...
    admiral_of_the_fleet = Constant('Admiral of the Fleet',
                                    'c2d9b924-6095-e211-a939-e4115bead28a')
    air_chief_marshal = Constant('Air Chief Marshal',
                                 'c3d9b924-6095-e211-a939-e4115bead28a')
    air_commodore = Constant('Air Commodore',
                             'c4d9b924-6095-e211-a939-e4115bead28a')
    air_marshal = Constant('Air Marshal',
                           'c5d9b924-6095-e211-a939-e4115bead28a')
    air_vice_marshal = Constant('Air Vice-Marshal',
                                'c6d9b924-6095-e211-a939-e4115bead28a')
    ...
    field_marshal = Constant('Field Marshal',
                             'ccd9b924-6095-e211-a939-e4115bead28a')
    flight_lieutenant = Constant('Flight Lieutenant',
                                 'cdd9b924-6095-e211-a939-e4115bead28a')
    flying_officer = Constant('Flying Officer',
                              'ced9b924-6095-e211-a939-e4115bead28a')
    general = Constant('General', 'cfd9b924-6095-e211-a939-e4115bead28a')
    group_captain = Constant('Group Captain',
                             'd0d9b924-6095-e211-a939-e4115bead28a')
    ...
    lieutenant_colonel = Constant('Lieutenant Colonel',
                                  'd3d9b924-6095-e211-a939-e4115bead28a')
    lieutenant_commander = Constant('Lieutenant Commander',
                                    'd2d9b924-6095-e211-a939-e4115bead28a')
    lieutenant_general = Constant('Lieutenant General',
                                  'd4d9b924-6095-e211-a939-e4115bead28a')
    lord = Constant('Lord', 'b9d9b924-6095-e211-a939-e4115bead28a')
    major = Constant('Major', 'd5d9b924-6095-e211-a939-e4115bead28a')
    major_general = Constant('Major General',
                             'd6d9b924-6095-e211-a939-e4115bead28a')
    marshal_of_the_raf = Constant('Marshal of the RAF',
                                  'd7d9b924-6095-e211-a939-e4115bead28a')
    ...
    pilot_officer = Constant('Pilot Officer',
                             'd8d9b924-6095-e211-a939-e4115bead28a')
    professor = Constant('Professor', 'bbd9b924-6095-e211-a939-e4115bead28a')
    rear_admiral = Constant('Rear Admiral',
                            'd9d9b924-6095-e211-a939-e4115bead28a')
    reverend = Constant('Reverend', 'b6d9b924-6095-e211-a939-e4115bead28a')
    second_lieutenant = Constant('Second Lieutenant',
                                 'dad9b924-6095-e211-a939-e4115bead28a')
    sir = Constant('Sir', 'b7d9b924-6095-e211-a939-e4115bead28a')
    squadron_leader = Constant('Squadron Leader',
                               'dbd9b924-6095-e211-a939-e4115bead28a')
    sub_lieutenant = Constant('Sub-Lieutenant',
                              '744cd12a-6095-e211-a939-e4115bead28a')
    ...
    vice_admiral = Constant('Vice Admiral',
                            '754cd12a-6095-e211-a939-e4115bead28a')
    wing_commander = Constant('Wing Commander',
                              '764cd12a-6095-e211-a939-e4115bead28a')
...
class UKRegion(Enum):
    ...
    channel_islands = Constant('Channel Islands',
                               '8b4cd12a-6095-e211-a939-e4115bead28a')
    east_midlands = Constant('East Midlands',
                             '844cd12a-6095-e211-a939-e4115bead28a')
    east_of_england = Constant('East of England',
                               '864cd12a-6095-e211-a939-e4115bead28a')
    ...
    isle_of_man = Constant('Isle of Man',
                           '8f4cd12a-6095-e211-a939-e4115bead28a')
    ...
    northern_ireland = Constant('Northern Ireland',
    ...
    ukti_dubai_hub = Constant('UKTI Dubai Hub',
                              'e1dd40e9-3dfd-e311-8a2b-e4115bead28a')
    wales = Constant('Wales', '8d4cd12a-6095-e211-a939-e4115bead28a')
    west_midlands = Constant('West Midlands',
                             '854cd12a-6095-e211-a939-e4115bead28a')
    yorkshire_and_the_humber = Constant('Yorkshire and The Humber',
...
class Service(Enum):
    ...
    trade_enquiry = Constant('Trade - Enquiry',
                             '330bba2b-3499-e211-a939-e4115bead28a')


class Team(Enum):
    """Team."""

    healthcare_uk = Constant('Healthcare UK',
                             '3ff47a07-002c-e311-a78e-e4115bead28a')
    crm = Constant('CRM', '5e8be8a8-3e95-e211-a939-e4115bead28a')
