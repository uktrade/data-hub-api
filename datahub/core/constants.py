...
class ExportSubSegment(Enum):
    ...
    sustain_nurture_and_grow = Constant('sustain_nurture_and_grow',
                                        'Sustain: nurture & grow')
    sustain_develop_export_capability = Constant('sustain_develop_export_capability',
                                                 'Sustain: develop export capability')
    sustain_communicate_benefits = Constant('sustain_communicate_benefits',
                                            'Sustain: communicate benefits')
    sustain_increase_competitiveness = Constant('sustain_increase_competitiveness',
                                                'Sustain: increase competitiveness')
    reassure_nurture_and_grow = Constant('reassure_nurture_and_grow',
                                         'Reassure: nurture & grow')
    reassure_develop_export_capability = Constant('reassure_develop_export_capability',
                                                  'Reassure: develop export capability')
    reassure_leave_be = Constant('reassure_leave_be',
                                 'Reassure: leave be')
    reassure_change_the_game = Constant('reassure_change_the_game',
                                        'Reassure: change the game')
    promote_develop_export_capability = Constant('promote_develop_export_capability',
                                                 'Promote: develop export capability')
    promote_communicate_benefits = Constant('promote_communicate_benefits',
                                            'Promote: communicate benefits')
    promote_change_the_game = Constant('promote_change_the_game',
