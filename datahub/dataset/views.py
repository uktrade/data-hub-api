...
class OMISDatasetView(HawkResponseSigningMixin, GenericAPIView):
    """
    An APIView that provides 'get' action which queries and returns desired
    fields for OMIS Dataset to be consumed by data-flow-api
    """
    ...
    def get_dataset(self):
        """Returns list of OMIS Dataset revords"""
        return Order.objects.prefetch_related('service_types').annotate(
