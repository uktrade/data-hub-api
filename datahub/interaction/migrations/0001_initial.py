...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('metadata', '0004_servicedeliverystatus_serviceprovider'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(db_index=True, default=uuid.uuid4, primary_key=True, serialize=False)),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metadata.Service')),
                ('service_provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metadata.ServiceProvider')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metadata.ServiceProvider'),
        ),
        migrations.AddField(
            model_name='servicedelivery',
            name='status',
