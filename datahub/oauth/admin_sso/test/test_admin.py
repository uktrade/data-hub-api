...
class TestAdminSite(AdminTestMixin):
    ...
    def test_oauth2_login_view_is_called_when_requesting_admin_login(self, _login):  # noqa: PT019
    ...
    def test_oauth2_login_view_is_called_when_requesting_admin_logout(self, _logout):  # noqa: PT019
