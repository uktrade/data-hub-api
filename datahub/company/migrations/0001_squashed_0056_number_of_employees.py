# Generated by Django 2.1.5 on 2019-02-14 15:04
import re
import uuid
...
class Migration(migrations.Migration):
    ...
    replaces = [('company', '0001_squashed_0010_auto_20170807_1124'), ('company', '0011_add_adviser_tel_num'), ('company', '0012_add_adviser_contact_email'), ('company', '0013_update_marketing_fields'), ('company', '0014_adding_read_permissions'), ('company', '0015_add_vat_number'), ('company', '0016_add_export_experience_category'), ('company', '0017_add_reference_code'), ('company', '0018_add_archived_documents_url_path'), ('company', '0019_use_urlfield_for_website'), ('company', '0020_auto_20171116_2153'), ('company', '0021_add_default_id_for_metadata'), ('company', '0022_fix_export_experience_cat_verbose_name'), ('company', '0023_update_superuser_status'), ('company', '0024_add_custom_document_read_permission'), ('company', '0025_company_global_headquarters'), ('company', '0026_add_sector_hierarchy'), ('company', '0027_add_timeline_permission'), ('company', '0028_core-team'), ('company', '0029_remove-parent-from-django'), ('company', '0030_update_permissions_django_21'), ('company', '0031_remove-parent-column'), ('company', '0032_add_export_permission'), ('company', '0033_add_export_permission'), ('company', '0034_remove-account-manager-from-django'), ('company', '0035_remove_account_manager_column'), ('company', '0036_update_contact_contactable_columns'), ('company', '0037_remove_contact_contactable_columns'), ('company', '0038_add_index_contact_email_upper'), ('company', '0039_use_cdms_auth-nullable'), ('company', '0040_add_transfer_fields'), ('company', '0041_remove_cdms_auth_from_db'), ('company', '0042_rename_to_one_list_core_team_member'), ('company', '0043_update_one_list_core_team_member_rels'), ('company', '0044_duns_number'), ('company', '0045_add_one_list_tier'), ('company', '0046_populate_one_list_tier'), ('company', '0047_duns_number_nullable'), ('company', '0048_one_list_tier_field'), ('company', '0049_populate_one_list_tier_field'), ('company', '0050_duns_number_remove_default'), ('company', '0051_duns_number_unique'), ('company', '0052_add_trading_names'), ('company', '0053_populate_trading_names'), ('company', '0054_trading_name_add_default'), ('company', '0055_turnover'), ('company', '0056_number_of_employees')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registered_address_country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='companieshousecompanies_with_country_registered_address', to='metadata.Country')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification', models.ForeignKey(blank=True, help_text='Deprecated - Please use One List tier field instead', null=True, on_delete=django.db.models.deletion.SET_NULL, to='metadata.CompanyClassification')),
                ...
                ('registered_address_country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='companies_with_country_registered_address', to='metadata.Country')),
                ('sector', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='metadata.Sector')),
                ('trading_address_country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='companies_with_country_trading_address', to='metadata.Country')),
                ...
                ('trading_names', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), blank=True, default=list, null=True, size=None)),
            ...
            options={
                'permissions': (
                    ('view_company_document', 'Can view company document'),
                    ('view_company_timeline', 'Can view company timeline'),
        ...
        # Creates an index on UPPER(email) on the Contact model (for use with the iexact look-up).
        # As Django does not support creating indexes on expressions, SQL is used.
        migrations.RunSQL(
            sql=['CREATE INDEX "company_contact_upper_email_244368" ON "company_contact" (UPPER("email"));'],
