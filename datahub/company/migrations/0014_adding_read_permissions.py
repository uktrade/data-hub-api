...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='advisor',
            options={'permissions': (('read_advisor', 'Can read adviser'),), 'verbose_name': 'adviser'},
        ),
        migrations.AlterModelOptions(
            name='companieshousecompany',
            options={'permissions': (('read_companieshousecompany', 'Can read companies house companies'),), 'verbose_name_plural': 'Companies House companies'},
        ),
        migrations.AlterModelOptions(
            name='company',
