...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='company',
            name='export_segment',
            field=models.CharField(blank=True, choices=[(None, 'No Export Segment or not known'), ('hep', ' High Export Potential'), ('non-hep', 'Non- High Export Potential')], default='', help_text='Segmentation of export', max_length=255),
        ),
        migrations.AddField(
            model_name='company',
