...
from datahub.company.test.factories import ArchivedContactFactory, CompanyFactory, CompanyWithAreaFactory, ContactFactory
    ...
    def test_with_manual_address(self, get_consent_fixture):
        ...
        response = self.api_client.post(
            ...
            data={
                ...
                'address_1': 'Foo st.',
                'address_2': 'adr 2',
                'address_town': 'Little Italy',
                'address_county': 'Manhattan',
                'address_area': {
    ...
    def test_with_address_same_as_company(self):
        ...
        response = self.api_client.post(
            ...
            data={
                ...
                'last_name': 'Nelson',
                'company': {
                    'id': CompanyWithAreaFactory().pk,
                },
                'email': 'foo@bar.com',
                'telephone_countrycode': '+44',
                'telephone_number': '123456789',
                'address_same_as_company': True,
                #'address_area': None, # the validation should still pass if address_same_as_company is set right?
                'primary': True,
            },
        )
...
class TestEditContact(APITestMixin):
    ...
    def test_patch(self):
        ...
        url = reverse('api-v4:contact:detail', kwargs={'pk': contact.pk})
    ...
    def test_cannot_update_if_archived(self):
        ...
        url = reverse('api-v4:contact:detail', kwargs={'pk': company.pk})
        response = self.api_client.patch(
            url,
            data={
                'first_name': 'new name',
...
class TestArchiveContact(APITestMixin):
    ...
    def test_archive_without_reason(self):
        ...
        contact = ContactFactory()
        url = reverse('api-v4:contact:archive', kwargs={'pk': contact.pk})
    ...
    def test_unarchive(self):
        ...
        url = reverse('api-v4:contact:unarchive', kwargs={'pk': contact.pk})
        response = self.api_client.post(url)
...
class TestViewContact(APITestMixin):
    ...
    def test_get_contact_without_view_document_permission(self):
        ...
        url = reverse('api-v4:contact:detail', kwargs={'pk': contact.id})
...
class TestContactVersioning(APITestMixin):
    ...
    def test_update_creates_a_new_version(self):
        ...
        response = self.api_client.patch(
            reverse('api-v4:contact:detail', kwargs={'pk': contact.pk}),
    ...
    def test_archive_creates_a_new_version(self):
        ...
        url = reverse('api-v4:contact:archive', kwargs={'pk': contact.id})
        response = self.api_client.post(url, data={'reason': 'foo'})
    ...
    def test_unarchive_creates_a_new_version(self):
        ...
        url = reverse('api-v4:contact:unarchive', kwargs={'pk': contact.id})
        response = self.api_client.post(url)
...
class TestAuditLogView(APITestMixin):
    ...
    def test_audit_log_view(self):
        ...
        url = reverse('api-v4:contact:audit-item', kwargs={'pk': contact.pk})
