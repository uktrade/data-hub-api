...
class EditContactV3TestCase(LeelooTestCase):
    ...
    def test_update(self):
        ...
        contact = ContactFactory(
            ...
            first_name='Oratio',
            last_name='Nelson',
            job_title=constants.Role.owner,
            company=company1,
            email='foo@bar.com',
            email_alternative='foo2@bar.com',
            primary=True,
        ...
        response = self.api_client.put(url, {
            'title': {
                'id': constants.Title.air_chief_marshal.value.id
            },
            'first_name': 'New Oratio',
            'last_name': 'New Nelson',
            'job_title': constants.Role.partner.value.name,
            'company': {
                'id': company2.pk
            },
            'email': 'new-foo@bar.com',
            'email_alternative': 'new-foo2@bar.com',
            'primary': False,
            'advisor': {
                'id': str(self.user.pk),
                'first_name': self.user.first_name,
            ...
            'telephone_countrycode': '+43',
            'telephone_number': '0123456789',
            'telephone_alternative': '0987654321',
            'address_same_as_company': False,
            'address_1': 'New Foo st.',
            'address_2': 'New adr 2',
            'address_3': 'New adr 3',
            'address_4': 'New adr 4',
            'address_town': 'New London',
            'address_county': 'New London',
            'address_country': {
                'id': constants.Country.ireland.value.id
            },
            'address_postcode': 'SW1A1AB',
            'notes': 'new lorem ipsum',
        ...
        assert response.json() == {
            ...
            'title': {
                'id': constants.Title.air_chief_marshal.value.id,
                'name': constants.Title.air_chief_marshal.value.name
            },
            'first_name': 'New Oratio',
            'last_name': 'New Nelson',
            'job_title': constants.Role.partner.value.name,
            ...
            'address_country': {
                'id': constants.Country.ireland.value.id,
                'name': constants.Country.ireland.value.name
            },
            'address_postcode': 'SW1A1AB',
            'notes': 'new lorem ipsum',
            'contactable_by_dit': True,
