...
from datahub.company.serializers import ContactDetailSerializerV4
...
class TestContactSerializerV4:
    """
    Tests for the V4 Contact Serializer. Checking that update / create notify the
    ...
    def test_serializer_update_partial_call_task(
        ...
        """
        contact = self._make_contact()
        c = ContactDetailSerializerV4(instance=contact, partial=True)
        c.update(c.instance, {
            'accepts_dit_email_marketing': True,
        })
        update_contact_task_mock.assert_called_once_with(
    ...
    def test_serializer_create_calls_task_with_area(self, update_contact_task_mock, synchronous_on_commit):
        """
        ...
        data = {
            ...
            'telephone_number': '141592653',
            'telephone_alternative': '141592653',
        ...
        c = ContactDetailSerializerV4(data=data, context={'request': request})
    ...
    def test_serializer_create_calls_task_with_no_area(self, update_contact_task_mock, synchronous_on_commit):
        """
        Ensure that consent service celery task is called when serializer.create
        is called.
        """
    ...
    def test_to_representation(
        ...
        contact_serialized = ContactDetailSerializerV4(instance=contact)
