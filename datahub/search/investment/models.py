...
class InvestmentProject(DocType, MapDBModelToDict):
    ...
    client_contacts = dsl_utils.contact_mapping('client_contacts')
    client_relationship_manager = dsl_utils.id_name_mapping()
    project_manager = dsl_utils.contact_mapping('project_manager')
    project_assurance_adviser = dsl_utils.contact_mapping('project_assurance_adviser')
    team_members = dsl_utils.contact_mapping('team_members')
    archived = Boolean()
    ...
    referral_source_advisor = dsl_utils.contact_mapping('referral_source_advisor')
