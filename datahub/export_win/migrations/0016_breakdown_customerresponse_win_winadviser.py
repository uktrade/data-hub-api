# Generated by Django 3.2.23 on 2023-11-23 15:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_potential', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='export_win.businesspotential', verbose_name='Medium-sized and high potential companies')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='company.company')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='metadata.country')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('customer_location', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='metadata.ukregion', verbose_name='HQ location')),
                ('export_experience', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='export_win.experiencecategories')),
                ('goods_vs_services', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='export_win.expectedvaluerelation', verbose_name='Does the expected value relate to')),
                ('hq_team', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='export_win.hqteamregionorpost', verbose_name='HQ team, Region or Post')),
                ('hvc', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='export_win.hvc', verbose_name='HVC code, if applicable')),
                ('hvo_programme', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='export_win.hvoprogrammes', verbose_name='HVO Programme, if applicable')),
                ('lead_officer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='lead_officer', to=settings.AUTH_USER_MODEL)),
                ('line_manager', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='line_manager', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('sector', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='metadata.sector')),
                ('team_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='export_win.teamtype')),
                ('type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='export_win.wintype', verbose_name='Type of win')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adviser', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('hq_team', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='export_win.hqteamregionorpost', verbose_name='HQ team, Region or Post')),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('team_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='export_win.teamtype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_marketing_source', models.CharField(blank=True, max_length=256, null=True, verbose_name='Other marketing source')),
                ('access_to_contacts', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='access_to_contacts', to='export_win.rating', verbose_name='Gaining access to contacts?')),
                ('access_to_information', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='access_to_information', to='export_win.rating', verbose_name='Getting information or improved understanding of the country?')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('developed_relationships', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='developed_relationships', to='export_win.rating', verbose_name='Developing or nurturing critical relationships?')),
                ('expected_portion_without_help', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='export_win.withoutoursupport', verbose_name='What value do you estimate you would have achieved without our support?')),
                ('gained_confidence', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='gained_confidence', to='export_win.rating', verbose_name='Having confidence to explore or expand in the country?')),
                ('improved_profile', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='improved_profile', to='export_win.rating', verbose_name='Improving your profile or credibility in the country?')),
                ('last_export', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='export_win.experience', verbose_name='Apart from this win, when did your company last export goods or services?')),
                ('marketing_source', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='export_win.marketingsource', verbose_name='How did you first hear about DBT (or its predecessor, DIT)?')),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('our_support', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='export_win.rating', verbose_name='Securing the win overall?')),
                ('overcame_problem', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='overcame_problem', to='export_win.rating', verbose_name='Overcoming a problem in the country (eg legal, regulatory, commercial)?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='export_win.breakdowntype')),
