...
class IProjectSerializer(PermittedFieldsModelSerializer):
    ...
    # SPI fields
    project_arrived_in_triage = serializers.DateTimeField(required=False, allow_null=True)
    proposal_deadline = serializers.DateTimeField(required=False, allow_null=True)
