...
def create_fake_file(records: list[dict] = None, default_faker: str = 'triage'):
    """Create a fake file with the specified list of records.
    ...
    if not records:
        if default_faker == 'triage':
            ...
            raise ValueError(f'Invalid value "{default_faker}" for argument default_faker')
    json_lines = [
