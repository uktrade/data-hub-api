...
class GreatIngestionTask:
    ...
    def json_to_model(self, jsn):
        ...
        values = {
            ...
            'data_full_name': data.get('full_name', '')[:255],
            'data_website_url': data.get('website_url', '')[:255],
            'data_company_name': data.get('company_name', '')[:255],
            'data_company_size': data.get('company_size', '')[:255],
            'data_phone_number': data.get('phone_number', '')[:255],
            'data_email_address': data.get('email_address', '')[:255],
            'data_terms_agreed': data.get('terms_agreed', False),
            'data_opportunities': data.get('opportunities', []),
            'data_role_in_company': data.get('role_in_company', '')[:255],
