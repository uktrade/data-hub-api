...
| `DNB_SERVICE_TOKEN`                                                   | No                                          | Access token provided by dnb-service through its djang-rest-framework token authentication.                                                                                                                             |
