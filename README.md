...
| `EXPORT_NOTIFICATION_NO_RECENT_INTERACTION_TEMPLATE_ID`               | Yes                                         | An ID of Notify Template for No Recent Export company Interaction notifications                                                                                                  |
| `EXPORT_WINS_NOTIFICATION_API_KEY`                                     | Yes                                         |                                                                                                                                                                                  |
| `EXPORT_WINS_CLIENT_RECEIPT_TEMPLATE_ID`               | Yes                                         | An ID of Notify Template for Export Wins Client Email Receipt notifications                                                                                                  |
| `EXPORT_WINS_LEAD_OFFICER_APPROVED_TEMPLATE_ID`               | Yes                                         | An ID of Notify Template for Export Wins Lead Officer Approved notifications                                                                                                  |
| `EXPORT_WINS_LEAD_OFFICER_REJECTED_TEMPLATE_ID`               | Yes                                         | An ID of Notify Template for Export Wins Lead Officer Rejected notifications                                                                                                  |
